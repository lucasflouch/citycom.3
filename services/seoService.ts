...
// Valores por defecto, extraídos del index.html para consistencia.
const DEFAULT_TITLE = 'Guía Comercial Argentina';
const DEFAULT_DESCRIPTION = 'Marketplace de comercios locales';

// Helper para obtener o crear una etiqueta <meta> y evitar errores.
...
// Helper para manejar el script de datos estructurados JSON-LD.
...
/**
 * Actualiza los meta tags y datos estructurados del <head> con la información de un comercio.
 */
export const updateMetaTagsForComercio = (comercio: Comercio, ciudad?: Ciudad, rubro?: Rubro) => {
    ...
    const pageUrl = window.location.href; // Ideal para compartir
...
/**
 * Resetea los meta tags a los valores por defecto del sitio.
 * Esencial para Single-Page Applications al navegar fuera de una página de detalle.
 */
